...
public class AppointmentController {
	...
	public ResponseEntity<Appointment> addAppointment(@PathVariable("doctorId") int doctorId,
			@PathVariable("patientId") int patientId, @Valid @RequestBody Appointment appointment) {
		return new ResponseEntity<Appointment>(appointmentService.addAppointment(appointment, doctorId, patientId),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Appointment> updateAppointmentById(@PathVariable("appointmentid") int appointmentid,
		...
		return new ResponseEntity<Appointment>(appointmentService.updateAppointmentById(appointmentid, appointment),
				HttpStatus.OK);
