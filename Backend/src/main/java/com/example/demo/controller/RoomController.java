...
public class RoomController {
	...
	public ResponseEntity<Room> addRoom(@PathVariable("patienId") int patientId, @Valid @RequestBody Room room) {
		return new ResponseEntity<Room>(roomService.addRoom(room, patientId), HttpStatus.CREATED);
	}
	...
	@PutMapping("{roomid}")
	public ResponseEntity<Room> updateRoomById(@PathVariable("roomid") int roomid, @RequestBody Room room) {
