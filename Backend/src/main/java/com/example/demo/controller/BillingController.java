...
public class BillingController {
	...
	public ResponseEntity<Billing> addBilling(@PathVariable("patientId") int patientId,
			@Valid @RequestBody Billing billing) {
		return new ResponseEntity<Billing>(billingService.addBilling(billing, patientId), HttpStatus.CREATED);
	}
