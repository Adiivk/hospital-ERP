...
public class LabTestController {
	...
	public ResponseEntity<LabTest> addLabTest(@PathVariable("patientId") int patientId,
			@Valid @RequestBody LabTest labTest) {
		return new ResponseEntity<LabTest>(labTestService.addLabTest(labTest, patientId), HttpStatus.CREATED);
	}
