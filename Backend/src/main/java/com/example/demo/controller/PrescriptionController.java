...
public class PrescriptionController {
	...
	public ResponseEntity<Prescription> addPrescription(@PathVariable("doctorId") int doctorId,
			@PathVariable("patientId") int patientId, @Valid @RequestBody Prescription prescription) {
		return new ResponseEntity<Prescription>(prescriptionService.addPrescription(prescription, doctorId, patientId),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Prescription> updatePrescriptionById(@PathVariable("prescriptionid") int prescriptionid,
		...
		return new ResponseEntity<Prescription>(
				prescriptionService.updatePrescriptionById(prescriptionid, prescription), HttpStatus.OK);
