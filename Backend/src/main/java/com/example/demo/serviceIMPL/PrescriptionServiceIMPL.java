...
public class PrescriptionServiceIMPL implements PrescriptionService {
	...
	@Override
	public Prescription addPrescription(Prescription prescription, int doctoId, int patientId) {
	...
	public String deletePrescriptionById(int prescriptionid) {
		// TODO Auto-generated method stub
		Prescription prescription = getPrescriptionById(prescriptionid);// to check the id is present in the table or
																		// not
	...
	public Prescription updatePrescriptionById(int prescriptionid, Prescription prescription) {
		// TODO Auto-generated method stub
		Prescription prescription1 = getPrescriptionById(prescriptionid);// to check the id is present in the table or
																			// not
